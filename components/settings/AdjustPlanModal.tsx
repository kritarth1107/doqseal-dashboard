...
export function AdjustPlanModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-[#f9f9f9] dark:bg-[#0b1220] text-zinc-900 dark:text-zinc-100 animate-in fade-in duration-200">
      <div className="flex items-center justify-between px-4 sm:px-8 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/80">
        <button
          type="button"
          onClick={onClose}
      ...
      {phoneModalPlan && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/40 dark:bg-black/60">
