      ...
      <main className="flex-1 flex flex-col items-center px-4 pb-16 pt-4 sm:pt-10">
        {step === 1 ? (
          <div className="w-full max-w-3xl animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="flex justify-center">
              <button
                ...
                onClick={() => setStep(2)}
                className="inline-flex items-center justify-center gap-2 min-w-[12rem] px-8 py-3.5 rounded-full bg-[#2563eb] text-white text-sm font-semibold hover:bg-[#1d4ed8] disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-sm hover:shadow-md"
              >
          ...
          <div className="w-full max-w-xl animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="bg-white rounded-3xl border border-zinc-200/80 shadow-sm p-6 sm:p-8 space-y-5">
              <Field label="Full name">
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm focus:outline-none focus:border-[#2563eb] focus:ring-1 focus:ring-[#2563eb]"
                />
              </Field>
                    ...
                    return (
                      <button
                        ...
                        className={`text-left text-sm px-3 py-2.5 rounded-xl border transition-all ${
                          selected
                            ? "border-[#2563eb] bg-[#2563eb]/5 text-[#1d4ed8] font-medium"
                  ...
                  {USE_CASES.map((uc) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 text-left text-sm px-3 py-2.5 rounded-xl border transition-all ${
                          selected
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="sm:flex-1 px-4 py-3 rounded-full border border-zinc-200 text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors"
                >
                  Back
                </button>
                <button
...
function IntentCard({
  ...
  return (
    <button
      type="button"
      onClick={onSelect}
      className={`group text-left rounded-3xl p-5 sm:p-6 border-2 transition-all duration-300 bg-white hover:-translate-y-0.5 hover:shadow-md ${
        selected
          ? "border-[#2563eb] bg-[#2563eb]/5 shadow-sm"
          : "border-transparent shadow-sm hover:border-zinc-200"
      }`}
    >
      <div className="h-40 sm:h-48 flex items-center justify-center mb-5 rounded-2xl bg-zinc-50 overflow-hidden">
        <img
          src={image}
          alt=""
      ...
      <h2 className="text-lg font-semibold text-zinc-900 mb-1.5">{title}</h2>
...
function Field({
  ...
  return (
    <div className="space-y-2">
      <label className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest px-0.5">
        {label}
      </label>
      {children}
    </div>
