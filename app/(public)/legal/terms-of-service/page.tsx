      ...
      <div className="max-w-4xl mx-auto bg-white border border-zinc-200 shadow-sm rounded-xl overflow-hidden print:border-none print:shadow-none print:rounded-none">
        ...
        <div className="p-8 sm:p-12 space-y-12 text-zinc-800 leading-[1.6] text-[15px] font-serif_disable">
          ...
          <div className="bg-zinc-50 border-l-4 border-zinc-900 p-6 space-y-3 italic">
            <p className="font-bold not-italic text-black text-sm uppercase tracking-widest">Notice to User:</p>
            <p>
              Please read these Terms of Service carefully. They constitute a legally binding agreement between you and Quadkubes Technology Studio Private Limited. By accessing or using the DoqSeal Platform, you agree to be bound by these Terms. If you do not agree, do not use the Platform.
            </p>
          </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-justify">
              ...
              <p>
                1.2 By creating an account, accessing, or using the DoqSeal website (doqseal.io), mobile application, APIs, or any related services (collectively, the "Platform"), you agree to be bound by these Terms and our Privacy Policy.
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <p>
                3.1 <strong>Account Security:</strong> You are responsible for maintaining the confidentiality of your credentials. Notify us immediately at security@doqseal.io upon becoming aware of any unauthorised use.
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <p>
                4.1 <strong>AI Accuracy:</strong> AI-extracted data may contain errors. DoqSeal AI extraction is designed to assist, not to replace human verification for critical decisions. You are solely responsible for verifying the accuracy of extracted data.
              </p>
              <p>
                4.2 <strong>Privacy Mode:</strong> On-device analysis is provided for sensitive documents. Such documents never leave your device and are not accessible by DoqSeal.
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <p>6.1 Pricing is as described on doqseal.io/pricing. Fees are quoted in INR.</p>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-zinc-900 text-zinc-400 p-6 rounded-lg font-mono text-[11px] leading-relaxed uppercase tracking-tight">
              ...
              "THE PLATFORM IS PROVIDED 'AS IS' WITHOUT WARRANTY OF ANY KIND. DOQSEAL'S TOTAL LIABILITY SHALL NOT EXCEED THE GREATER OF FEES PAID IN THE PRECEDING 3 MONTHS OR INR 10,000. IN NO EVENT SHALL WE BE LIABLE FOR CONSEQUENTIAL LOSS."
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="p-6 bg-zinc-50 border border-zinc-200 rounded-lg space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
                <div>
                  <p className="font-bold text-zinc-900">Arbitration</p>
                  <p className="text-zinc-500">Seat: Raipur, Chhattisgarh</p>
                  <p className="mt-2 text-zinc-500">legal@doqseal.io</p>
                </div>
