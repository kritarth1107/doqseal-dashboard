                ...
                <div className="max-w-3xl w-full flex flex-col items-center justify-center -mt-16 text-center">
                    ...
                    <div className="w-full max-w-2xl bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden flex flex-col focus-within:ring-1 focus-within:ring-gray-300 transition-all">
                        <textarea
                            ...
                            placeholder="Ask across your organisation documents, projects, or envelopes…"
                        />
                    ...
                    >
                        <button
                            onClick={() => setQuery("List fasting requirements for all tests in the Test Request Form project...")}
                        ...
                        <button
                            onClick={() => setQuery("Compare liability clauses across signed contracts in Drive...")}
                            className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors shadow-sm cursor-pointer"
                        >
                        ...
                        <button
                            onClick={() => setQuery("List envelopes awaiting signature this week")}
                            className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors shadow-sm cursor-pointer"
                        >
